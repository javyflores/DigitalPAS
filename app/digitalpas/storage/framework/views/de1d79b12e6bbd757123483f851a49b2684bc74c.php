...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3"><?php echo e($tipouser); ?></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="nacafiliaciones">Consultar</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="nacsoltramite">Consultar</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="nacvisitas">Consultar</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <img src="<?php echo e(asset('img/camp.svg')); ?>">
                                <!-- Counter - Alerts -->
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?php echo e(asset('img/message.svg')); ?>">
                                <!-- Counter - Messages -->
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <?php $__currentLoopData = $nuevavisit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="mr-3">
                                            <div class="icon-circle bg-primary">
                                        ...
                                        <div>
                                            <div class="small text-gray-500"><?php echo e($visita->fec_crea); ?></div>
                                            <span class="font-weight-bold">Plantel: <?php echo e($visita->dependencia); ?></span>
                                            <div class="small text-gray-500">Solicitado por:
                                                <strong><?php echo e($visita->p_nombre_sol); ?> <?php echo e($visita->p_apellido_sol); ?></strong></div>
                                        </div>
                                    </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?php echo e(route('afiliado.solicitudpdf')); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Generar Documento PDF</a>
                    </div>              
    ...
    <a class="scroll-to-top rounded" href="#page-top">
        <img src="<?php echo e(asset('img/to-top.svg')); ?>">
    </a>
...
</html><?php /**PATH C:\xampp\htdocs\DigitalPAS\app\digitalpas\resources\views/nacionales.blade.php ENDPATH**/ ?>