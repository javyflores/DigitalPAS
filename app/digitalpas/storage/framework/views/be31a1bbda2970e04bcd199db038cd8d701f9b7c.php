...
<div>
    ...
    <div>
    	<?php if(session('sol_asistencia')): ?>
        <h1>Detalles de la solicitud de asistencia</h1>
        <p>Requerimiento: <?php echo e(session('sol_asistencia')->req); ?></p>
        <?php endif; ?>
    </div>
	  ...
	  <div class="imp">
		  <h3>Comprobante de Solicitud N° <?php echo e(session('usuario')); ?> </h3>
...
<?php echo $__env->make('layouts.afilplantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digitalpas\DigitalPAS\app\digitalpas\resources\views/afiliado\confSolAsist.blade.php ENDPATH**/ ?>