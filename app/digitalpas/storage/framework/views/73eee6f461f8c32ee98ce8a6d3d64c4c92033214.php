...
<h5>Hola <?php echo e($usuario); ?> aca puedes Solicitar una visita a tu centro de trabajo</h5>
...
<form class="form-horizontal" method="POST">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="fec_crea" id="fec_crea" value= "<?php echo e(now()); ?>" readonly>
    </div>
  </div>
  ...
  <input type="hidden" name="cod_usr_sol" id="cod_usr_sol" value="<?php echo e($codigo); ?>">
...
<?php echo $__env->make('layouts.afilplantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DigitalPAS\app\digitalpas\resources\views\afiliado\afilnewvisit.blade.php ENDPATH**/ ?>