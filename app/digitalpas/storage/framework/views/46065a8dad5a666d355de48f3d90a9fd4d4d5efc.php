    ...
    <style>
      ...
      .select-wrapper {
        ...
        select {
            ...
            border-radius: 8px;
            cursor: pointer;
            -webkit-appearance: none; /* Elimina la apariencia predeterminada solo para Safari */
            -moz-appearance: none; /* Elimina la apariencia predeterminada solo para Firefox */
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="row">
                ...
                <section class="price container">
                    ...
                    <!-- Agregamos el botón junto al select -->
                    <button class="button" onclick="exceldownload()"><i class="fas fa-file-alt fa-icon"></i>Generar Reporte</button>
                </section>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\DigitalPAS\app\digitalpas\resources\views\afiliado\afiliadoReport.blade.php ENDPATH**/ ?>