...
<body class="bg-default">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark">
      <div class="container px-4">
        <a class="navbar-brand" href="<?php echo e(url()->current()); ?>">
          <!-- Cambiar a URL del sindicato -->
          <img src="<?php echo e(asset('img/Logo Sirtrame.png')); ?>" width="80" height="100">
        </a>
            ...
            <div class="row">
              <div class="col-6 collapse-brand">
                <a href="<?php echo e(url()->current()); ?>">
                  <!-- Cambiar a URL del sindicato -->
                  <img src="<?php echo e(asset('img/Logo Sirtrame.png')); ?>">
                </a>
              </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="">
                ...
                <span class="nav-link-inner--text">Comenta</span>
              </a>
            </li>
          </ul>
        </div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <div class="text-center">
                  <img src="<?php echo e(asset('img/DigitalPASirtrame.jpg')); ?>" width="200" height="50">
                </div>
              ...
              <form method="POST" role="form">
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Usuario:" type="usuario" name="username">
                  </div>
                </div>
  ...
  <script src="<?php echo e(asset('js/login.min.js?v=1.1.2')); ?>"></script>

</body>

</html><?php /**PATH C:\xampp\htdocs\DigitalPAS\app\digitalpas\resources\views/layouts/form.blade.php ENDPATH**/ ?>