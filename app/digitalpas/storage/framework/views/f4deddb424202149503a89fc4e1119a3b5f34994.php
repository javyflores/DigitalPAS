    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3"><?php echo e(session('tipouser')); ?></div>
            </a>
...
</html><?php /**PATH C:\xampp\htdocs\DigitalPAS\app\digitalpas\resources\views/layouts/dirsecplantilla.blade.php ENDPATH**/ ?>