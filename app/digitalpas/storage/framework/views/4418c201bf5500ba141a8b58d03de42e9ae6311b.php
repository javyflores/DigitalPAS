	...
	<form>
	  ...
	  <div class="imp">
		  ...
		  <div class="container" style="background-color:white">
			  ...
			  <div>
			  <label>Cédula para afiliar:</label>
		      <input type="text" name="ced_sol" id="ced_sol" value= " <?php echo e($sol_asis->cedula); ?>" style="background-color:rgba(253, 253, 150, 0.2)" readonly>
		      </div>
...
<?php echo $__env->make('layouts.dirsecplantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DigitalPAS\app\digitalpas\resources\views/seccional/secafilcons.blade.php ENDPATH**/ ?>