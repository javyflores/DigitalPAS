...
<form class="form-horizontal" method="POST">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="usuario" value= "{{ $req }}" readonly>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="ced_afi" id="ced_afi" value= "{{ $solicitud->ced_afi }}" readonly>
    </div>
  </div>
  ...
  <input type="hidden" name="req_reg" id="req_reg" value="{{ $solicitud->req_reg }}">

  <input type="hidden" name="edo" id="edo" value="{{ $solicitud->edo }}">
  
  <input type="hidden" name="cod_usr" id="cod_usr" value="{{ $solicitud->cod_usr }}">
  
  <input type="hidden" name="cod_tipo" id="cod_tipo" value="{{ $solicitud->cod_tipo }}">

  <div class="form-group">
    <label class="control-label col-sm-2">Fecha de la Solicitud:</label>
    <div class="col-sm-10">
      <input type="text" name="fec_crea" id="fec_crea" value= "{{ $solicitud->fec_crea }}" readonly>
    </div>
  </div>
