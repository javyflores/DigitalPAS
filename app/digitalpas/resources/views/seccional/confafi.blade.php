    ...
    <div class="imp">
      ...
      <div class="container" style="background-color:white">
          ...
          <div>
            ...
            <input type="text" name="name" value= "{{ $afiliacion->p_nombre }} {{ $afiliacion->p_apellido }}" style="background-color:rgba(255, 105, 97, 0.1)" readonly>
          </div>

          <div>
              <label>Cédula de Identidad N°:</label>
              <input type="text" name="ced_sol" id="ced_sol" value= " {{ $afiliacion->cedula }}" style="background-color:rgba(253, 253, 150, 0.2)" readonly>
          </div>
          ...
          <div>
            ...
            <input type="text" name="fec_crea" id="fec_crea" value= "{{ $afiliacion->fec_crea }}" style="background-color: rgba(119, 221, 119, 0.2)" readonly>
          </div>
